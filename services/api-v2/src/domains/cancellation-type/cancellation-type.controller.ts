...
import ObjDto from './cancellation-type.dto'
import ObjSchema from './cancellation-type.model'

export default class CancellationTypeController extends Controller {
