...
import ObjDto from './movement-of-cash-box.dto'
import ObjSchema from './movement-of-cash-box.model'

export default class MovementOfCashBoxController extends Controller {
