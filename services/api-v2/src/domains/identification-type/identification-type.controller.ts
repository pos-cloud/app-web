...
import ObjDto from './identification-type.dto'
import ObjSchema from './identification-type.model'

export default class IdentificationTypeController extends Controller {
