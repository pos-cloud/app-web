...
async function register(req, res, next) {
	try {
		...
		let transactionTypes = [
			// VENTA
			{ transactionMovement: 'Venta', name: 'Ticket', currentAccount: 'No', requestCompany: 'Cliente', entryAmount: "Venta con IVA", fixedLetter: 'X', movement: 'Entrada', modifyStock: false, stockMovement: null, requestArticles: true, modifyArticle: false, requestTaxes: true, requestPaymentMethods: true, defectOrders: false, electronics: false, resetNumber: false, showPrices: true, printable: true, defectPrinter: defectPrinter, tax: false, cashBoxImpact: false, cashOpening: false, cashClosing: false, allowDelete: true, codes: [], company: companySaved._id },
			{ transactionMovement: 'Venta', name: 'eFactura', currentAccount: 'Si', requestCompany: 'Cliente',entryAmount: "Venta con IVA", fixedLetter: '', movement: 'Entrada', modifyStock: true, stockMovement: 'Salida', requestArticles: true, modifyArticle: false, requestTaxes: true, requestPaymentMethods: true, defectOrders: false, electronics: false, resetNumber: false, showPrices: true, printable: true, defectPrinter: defectPrinter, tax: true, cashBoxImpact: true, cashOpening: false, cashClosing: false, allowDelete: true, codes: [{ 'code': 1, 'letter': 'A' }, { 'code': 6, 'letter': 'B' }, { 'code': 11, 'letter': 'C' }] },
			{ transactionMovement: 'Venta', name: 'eNota de Crédito', currentAccount: 'Si', requestCompany: 'Cliente',entryAmount: "Venta con IVA", fixedLetter: '', movement: 'Salida', modifyStock: true, stockMovement: 'Entrada', requestArticles: true, modifyArticle: false, requestTaxes: true, requestPaymentMethods: true, defectOrders: false, electronics: false, resetNumber: false, showPrices: true, printable: true, defectPrinter: defectPrinter, tax: true, cashBoxImpact: true, cashOpening: false, cashClosing: false, allowDelete: true, codes: [{ 'code': 3, 'letter': 'A' }, { 'code': 8, 'letter': 'B' }, { 'code': 13, 'letter': 'C' }] },
			...
			// INVENTARIO
			{ transactionMovement: 'Stock', name: 'Inventario', currentAccount: 'No', requestCompany: null,entryAmount: "Costo sin IVA", fixedLetter: 'X', movement: null, modifyStock: true, stockMovement: 'Inventario', requestArticles: true, modifyArticle: false, requestTaxes: false, requestPaymentMethods: false, defectOrders: false, electronics: false, resetNumber: false, showPrices: false, printable: false, defectPrinter: defectPrinter, tax: false, cashBoxImpact: false, cashOpening: false, cashClosing: false, allowDelete: true, codes: [] },
			{ transactionMovement: 'Stock', name: 'Entrada de Producto', currentAccount: 'No', requestCompany: null,entryAmount: "Costo sin IVA", fixedLetter: 'X', movement: null, modifyStock: true, stockMovement: 'Entrada', requestArticles: true, modifyArticle: false, requestTaxes: false, requestPaymentMethods: false, defectOrders: false, electronics: false, resetNumber: false, showPrices: false, printable: false, defectPrinter: defectPrinter, tax: false, cashBoxImpact: false, cashOpening: false, cashClosing: false, allowDelete: true, codes: [] },
			{ transactionMovement: 'Stock', name: 'Salida de Producto', currentAccount: 'No', requestCompany: null,entryAmount: "Costo sin IVA", fixedLetter: 'X', movement: null, modifyStock: true, stockMovement: 'Salida', requestArticles: true, modifyArticle: false, requestTaxes: false, requestPaymentMethods: false, defectOrders: false, electronics: false, resetNumber: false, showPrices: false, printable: false, defectPrinter: defectPrinter, tax: false, cashBoxImpact: false, cashOpening: false, cashClosing: false, allowDelete: true, codes: [] },
			{ transactionMovement: 'Stock', name: 'Transferencia', currentAccount: 'No', requestCompany: null,entryAmount: "Costo sin IVA", fixedLetter: 'X', movement: null, modifyStock: true, stockMovement: 'Transferencia', requestArticles: true, modifyArticle: false, requestTaxes: false, requestPaymentMethods: false, defectOrders: false, electronics: false, resetNumber: false, showPrices: false, printable: false, defectPrinter: defectPrinter, tax: false, cashBoxImpact: false, cashOpening: false, cashClosing: false, allowDelete: true, codes: [] },
			// CAJA
			{ transactionMovement: 'Fondos', name: 'Apertura de Caja', currentAccount: 'No', requestCompany: null, fixedLetter: 'X',entryAmount: "Costo sin IVA", movement: 'Entrada', modifyStock: false, stockMovement: null, requestArticles: false, modifyArticle: false, requestTaxes: false, requestPaymentMethods: true, defectOrders: false, electronics: false, resetNumber: false, showPrices: false, printable: false, defectPrinter: defectPrinter, tax: false, cashBoxImpact: true, cashOpening: true, cashClosing: false, allowDelete: true, codes: [] },
			{ transactionMovement: 'Fondos', name: 'Cierre de Caja', currentAccount: 'No', requestCompany: null, fixedLetter: 'X',entryAmount: "Costo sin IVA", movement: 'Salida', modifyStock: false, stockMovement: null, requestArticles: false, modifyArticle: false, requestTaxes: false, requestPaymentMethods: true, defectOrders: false, electronics: false, resetNumber: false, showPrices: false, printable: false, defectPrinter: defectPrinter, tax: false, cashBoxImpact: true, cashOpening: false, cashClosing: true, allowDelete: true, codes: [] },
