...
async function register(req, res, next) {
	try {
		...
		let transactionTypes = [
			...
			// INVENTARIO
			{ transactionMovement: 'Stock', name: 'Inventario', currentAccount: 'No', requestCompany: null,entryAmount: "Costo sin IVA", fixedLetter: 'X', movement: null, modifyStock: true, stockMovement: 'Inventario', requestArticles: true, modifyArticle: false, requestTaxes: false, requestPaymentMethods: false, defectOrders: false, electronics: false, resetNumber: false, showPrices: true, printable: false, defectPrinter: defectPrinter, tax: false, cashBoxImpact: false, cashOpening: false, cashClosing: false, allowDelete: true, codes: [] },
			{ transactionMovement: 'Stock', name: 'Entrada de Producto', currentAccount: 'No', requestCompany: null,entryAmount: "Costo sin IVA", fixedLetter: 'X', movement: null, modifyStock: true, stockMovement: 'Entrada', requestArticles: true, modifyArticle: false, requestTaxes: false, requestPaymentMethods: false, defectOrders: false, electronics: false, resetNumber: false, showPrices: true, printable: false, defectPrinter: defectPrinter, tax: false, cashBoxImpact: false, cashOpening: false, cashClosing: false, allowDelete: true, codes: [] },
			{ transactionMovement: 'Stock', name: 'Salida de Producto', currentAccount: 'No', requestCompany: null,entryAmount: "Costo sin IVA", fixedLetter: 'X', movement: null, modifyStock: true, stockMovement: 'Salida', requestArticles: true, modifyArticle: false, requestTaxes: false, requestPaymentMethods: false, defectOrders: false, electronics: false, resetNumber: false, showPrices: true, printable: false, defectPrinter: defectPrinter, tax: false, cashBoxImpact: false, cashOpening: false, cashClosing: false, allowDelete: true, codes: [] },
			{ transactionMovement: 'Stock', name: 'Transferencia', currentAccount: 'No', requestCompany: null,entryAmount: "Costo sin IVA", fixedLetter: 'X', movement: null, modifyStock: true, stockMovement: 'Transferencia', requestArticles: true, modifyArticle: false, requestTaxes: false, requestPaymentMethods: false, defectOrders: false, electronics: false, resetNumber: false, showPrices: true, printable: false, defectPrinter: defectPrinter, tax: false, cashBoxImpact: false, cashOpening: false, cashClosing: false, allowDelete: true, codes: [] },
			// CAJA
