...
export class StatisticsComponent implements OnInit {
  ...
  @ViewChild(ReportBestSellingArticleComponent, { static: true })
  reportBestSellingArticle: ReportBestSellingArticleComponent;
  @ViewChild(ReportSalesByPaymentMethodComponent, { static: true })
  reportSalesByPaymentMethod: ReportSalesByPaymentMethodComponent;
  @ViewChild(ReportSalesByClientComponent, { static: true })
