...
export class StructureComponent implements OnInit {
  ...
  public setValueForm(): void {
    ...
    if (!this.structure.quantity) {
      this.structure.quantity = 0;
    }
    if (!this.structure.utilization) {
      this.structure.utilization = Utilization.Sale;
    }
    if (!this.structure.increasePrice) {
      this.structure.increasePrice = 0;
    }
  ...
  public buildForm(): void {
    this.structureForm = this._fb.group({
      _id: [this.structure._id, []],
      parent: [this.structure.parent, [Validators.required]],
      child: [this.structure.child, [Validators.required]],
      quantity: [this.structure.quantity, [Validators.required]],
      utilization: [this.structure.utilization, [Validators.required]],
      optional: [this.structure.optional, []],
      increasePrice: [this.structure.increasePrice, []],
    });
