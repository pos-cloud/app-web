...
import { DeleteVariantTypeComponent } from '../delete-variant-type/delete-variant-type.component';
import { UpdateVariantTypeComponent } from '../update-variant-type/update-variant-type.component';
import { AddVariantTypeComponent } from '../variant-type/add-variant-type.component';
...
export class ListVariantTypesComponent implements OnInit {
  ...
  @Output() eventAddItem: EventEmitter<VariantType> =
    new EventEmitter<VariantType>();
  ...
  public openModal(op: string, variantType: VariantType): void {
    ...
    switch (op) {
      case 'view':
        modalRef = this._modalService.open(UpdateVariantTypeComponent, {
          size: 'lg',
          backdrop: 'static',
        });
      ...
      case 'add':
        modalRef = this._modalService
          .open(AddVariantTypeComponent, { size: 'lg', backdrop: 'static' })
          .result.then(
            (result) => {
              this.getVariantTypes();
            },
      ...
      case 'update':
        ...
        break;
      case 'delete':
        modalRef = this._modalService.open(DeleteVariantTypeComponent, {
          size: 'lg',
          backdrop: 'static',
        });
        modalRef.componentInstance.variantType = variantType;
