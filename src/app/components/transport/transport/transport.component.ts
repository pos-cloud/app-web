...
export class TransportComponent implements OnInit {
  ...
  public setValueForm(): void {
    ...
    if (!this.transport.identificationValue) {
      this.transport.identificationValue = '';
    }
    if (!this.transport.address) {
      this.transport.address = '';
    }
    if (!this.transport.addressNumber) {
      this.transport.addressNumber = '';
    }
    ...
    if (!this.transport.city) {
      this.transport.city = '';
    }
    if (!this.transport.phones) {
      this.transport.phones = '';
    }
    if (!this.transport.emails) {
      this.transport.emails = '';
    }
    if (!this.transport.observation) {
      this.transport.observation = '';
    }
