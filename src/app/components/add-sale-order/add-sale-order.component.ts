...
export class AddSaleOrderComponent {
  ...
  @ViewChild('contentMessage', {static: false}) contentMessage: ElementRef;
  @ViewChild('contentChangeDate', {static: false}) contentChangeDate: ElementRef;
  @ViewChild('contentChangeQuotation', {static: false}) contentChangeQuotation: ElementRef;
  @ViewChild('containerMovementsOfArticles', {static: false}) containerMovementsOfArticles: ElementRef;
  @ViewChild('containerTaxes', {static: false}) containerTaxes: ElementRef;
  ...
  @ViewChild(ListArticlesComponent, {static: false}) listArticlesComponent: ListArticlesComponent;
