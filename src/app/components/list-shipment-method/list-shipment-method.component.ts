...
import { ShipmentMethod,attributes } from "../../models/shipment-method"
...
@Component({
  ...
  styleUrls: ['./list-shipment-method.component.css']
})
export class ListShipmentMethodComponent implements OnInit {

	public userCountry: string;

	public totalItems: number = 0;
	public title: string = "Listado de Métodos de Envío"
	...
	public getItems(): void {
		...
		this.subscription.add(this._shipmentMethodService.getShipmentMethods(
			project, // PROJECT
			match, // MATCH
			this.sort, // SORT
			group, // GROUP
	...
	public openModal(op: string, shipmentMethod: ShipmentMethod): void {
		...
		switch (op) {
			...
			case 'view':
				modalRef = this._modalService.open(ShipmentMethodComponent, { size: 'lg', backdrop: 'static' });
				modalRef.componentInstance.shipmentMethodId = shipmentMethod._id;
