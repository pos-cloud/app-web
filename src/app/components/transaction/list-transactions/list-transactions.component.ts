        ...
        switch (op) {
            ...
            case 'send-email':
                ...
                if (Config.country === 'MX') {
                    modalRef.componentInstance.body += ` y su XML correspondiente en <a href="http://${Config.apiHost}:300/api/print/xml/CFDI-33_Factura_` + transaction.number +`">Su comprobante</a>`;
                }
