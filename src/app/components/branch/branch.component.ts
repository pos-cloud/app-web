        ...
        return new Promise((resolve, reject) => {
            ...
            if (this.branches && this.branches.length > 0 && this.branch.default !== null) {
                for (const element of this.branches) {
                    if (this.operation === "add" && this.branch.default && element.default === this.branch.default) {
                        this.showMessage("Solo puede existir una sucursal por defecto.", 'danger', true);
                        resolve(false)
                    }
                    ...
                    if(this.operation === "edit" && 
                        ...
                        this.showMessage("Solo puede existir una sucursal por defecto","danger",false)
                        resolve(false)
                    }
                }
                resolve(true)
