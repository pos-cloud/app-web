...
export class TransactionTypeComponent implements OnInit {
	...
	public formErrors = { 'transactionMovement': '', 'abbreviation': '', 'name': '', };

	public validationMessages = {
		'transactionMovement': { 'required': 'Este campo es requerido.', },
		'abbreviation': { 'maxlength': 'No puede exceder los 2 carácteres.', },
