...
export class ListCountriesComponent implements OnInit {
  ...
  public displayedColumns = ['code', 'name', 'flag', 'operationType'];
  public filters: any[];
  ...
  public async importCountries() {
    ...
    this._configService.getCountry().subscribe(async (result) => {
      if (result) {
  ...
  public openModal(op: string, country?: Country): void {
    ...
    switch (op) {
      case 'add':
        modalRef = this._modalService.open(CountryComponent, {
          size: 'lg',
          backdrop: 'static',
        });
