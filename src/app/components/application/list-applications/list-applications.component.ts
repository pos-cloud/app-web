...
import { attributes, Application } from "../application"
...
export class ListApplicationsComponent implements OnInit {
	...
	public getItems(): void {
		...
		this.subscription.add(this._applicationService.getApplications(
			project, // PROJECT
			match, // MATCH
			this.sort, // SORT
			group, // GROUP
	...
	public openModal(op: string, application: Application): void {
		...
		switch (op) {
			...
			case 'view':
				modalRef = this._modalService.open(ApplicationComponent, { size: 'lg', backdrop: 'static' });
				modalRef.componentInstance.applicationId = application._id;
