...
export class ApplicationComponent implements OnInit {
  ...
  filesToUploadHome: any[] = new Array();
  ...
  formFields: FormField[] = [
    ...
    },
    {
      ...
      tagType: 'text',
      default:
        'Le notificaremos todos los detalles por correo electrónico. ¡Muchas Gracias por su compra!',
      multiple: true,
      class: 'form-group col-md-6',
    },
    {
  ...
  public addSchedule(scheduleForm: NgForm): void {
    ...
    if (
      ...
      scheduleForm.value.from === '' ||
      scheduleForm.value.to === ''
    ) {
  ...
  public authMeli() {
    ...
    window.open(
      `http://auth.mercadolibre.com.ar/authorization?response_type=code&client_id=${clientId}&state=${stateMeli}`,
    );
  }
