...
const _routes: Routes = [
  ...
  { path: 'admin/clientes', component: ListCompaniesComponent, canActivate: [AuthGuard], data: { roles: ['Supervisor'] } },
  { path: 'admin/proveedores', component: ListCompaniesComponent, canActivate: [AuthGuard], data: { roles: ['Supervisor'] } },
  ...
  { path: 'pos/resto/salones/:id/mesas/:id/agregar-ticket', component: AddSaleOrderComponent },
  ...
  { path: 'pos/mostrador/agregar-nota-debito', component: AddSaleOrderComponent },
  ...
  { path: 'pos/mostrador/editar-nota-debito/:id', component: AddSaleOrderComponent },
  { path: 'login', component: LoginComponent },
