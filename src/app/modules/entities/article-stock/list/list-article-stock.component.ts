...
export class ListArticleStockComponent implements OnInit {
  ...
  public columns: IAttribute[] = [
    ...
    {
      name: 'article.variantType2.name',
      visible: false,
      disabled: false,
      filter: true,
      datatype: 'string',
    ...
    {
      name: 'article.variantValue2.description',
      visible: false,
      disabled: false,
      filter: true,
      datatype: 'string',
    ...
    {
      name: 'article.publishTiendaNube',
      visible: false,
      disabled: false,
      filter: true,
      datatype: 'boolean',
    ...
    {
      name: 'article.publishWooCommerce',
      visible: false,
      disabled: false,
      filter: true,
      datatype: 'boolean',
