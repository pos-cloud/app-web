...
export class ListIdentificationTypesComponent {
  public title: string = 'identification-type';
  public sort = { name: 1 };
  ...
  public async redirect(op: string, obj: any) {
    switch (op) {
      case 'view':
        this._router.navigateByUrl('entities/identification-type/view/' + obj._id);
        break;
      case 'update':
        this._router.navigateByUrl('entities/identification-type/update/' + obj._id);
        break;
      case 'delete':
        this._router.navigateByUrl('entities/identification-type/delete/' + obj._id);
        break;
      case 'add':
        this._router.navigateByUrl('entities/identification-type/add');
        break;
    }
  }
