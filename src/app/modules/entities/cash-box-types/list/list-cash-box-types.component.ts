  ...
  public async openModal(op: string, obj: any) {
    switch (op) {
       case 'view':
        ...
        break;
      case 'add':
        this._router.navigateByUrl('entities/cash-box-types/add');
        break;
      case 'update':
        this._router.navigateByUrl('entities/cash-box-types/update/' + obj._id);
        break;
      case 'delete':
        this._router.navigateByUrl('entities/cash-box-types/delete/' + obj._id);
        break;
      default:
    }
  }
