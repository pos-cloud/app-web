  ...
  public async openModal(op: string, obj: any) {
    switch (op) {
      case 'view':
        ...
        break;
      case 'add':
        this._router.navigateByUrl('entities/vat-condition/add');
        break;
      case 'update':
        this._router.navigateByUrl('entities/vat-condition/update/' + obj._id);
        break;
      case 'delete':
        this._router.navigateByUrl('entities/vat-condition/delete/' + obj._id);
        break;
      default:
    }
  }
