...
import { ArticleService, PrinterService } from '@core/services';
...
@Component({
  ...
  templateUrl: './list-variants.components.html',
...
export class ListVariantsComponent implements OnInit {
  ...
  public async openModal(op: string, obj: any, items) {
    ...
    switch (op) {
      case 'view':
        this._router.navigateByUrl('entities/articles/variants/view/' + obj._id);
        break;
      case 'update':
        this._router.navigateByUrl('entities/articles/variants/update/' + obj._id);
        break;
