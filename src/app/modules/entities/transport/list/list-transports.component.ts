...
export class ListTransportsComponent {
  ...
  public title: string = 'transports';
  public sort = { name: 1 };
  ...
  public async redirect(op: string, obj: any) {
    switch (op) {
      case 'view':
        this._router.navigateByUrl('entities/transports/view/' + obj._id);
        break;
      case 'update':
        this._router.navigateByUrl('entities/transports/update/' + obj._id);
        break;
      case 'delete':
        this._router.navigateByUrl('entities/transports/delete/' + obj._id);
        break;
      case 'add':
        this._router.navigateByUrl('entities/transports/add');
        break;
    }
  }
