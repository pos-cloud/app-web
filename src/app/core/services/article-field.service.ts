...
import { ArticleField } from '../../components/article-field/article-field';
...
export class ArticleFieldService extends ModelService {
  ...
  public getArticleFields(query?: string): Observable<any> {
  ...
  public updateArticleField(articleField: ArticleField): Observable<any> {
    ...
    const params = new HttpParams().set('id', articleField._id);

    return this._http
      .put(URL, articleField, {
        headers: headers,
        params: params,
      })
      .pipe(
