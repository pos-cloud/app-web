...
import { CompanyGroup } from '../../components/company-group/company-group';
import { AuthService } from './auth.service';

@Injectable({
  providedIn: 'root',
})
export class CompanyGroupService extends ModelService {
  constructor(
  ...
  public getCompaniesGroups(query?: string): Observable<any> {
  ...
  public updateCompanyGroup(companyGroup: CompanyGroup): Observable<any> {
    ...
    const params = new HttpParams().set('id', companyGroup._id);

    return this._http
      .put(URL, companyGroup, {
        headers: headers,
        params: params,
      })
      .pipe(
