...
import { VariantValue } from '../../components/variant-value/variant-value';
...
export class VariantValueService extends ModelService {
  ...
  public updateVariantValue(variantValue: VariantValue): Observable<any> {
    ...
    const params = new HttpParams().set('id', variantValue._id);

    return this._http
      .put(URL, variantValue, {
        headers: headers,
        params: params,
      })
      .pipe(
