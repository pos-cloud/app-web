  ...
  public async openModal(op: string, obj: any, items) {
    ...
    switch (op) {
      case 'view':
        ...
        this._router.navigate(['/entities/articles/view', obj._id], {
          queryParams: { returnURL: currentUrl },
        });
        break;
      case 'add':
        currentUrl = encodeURIComponent(this._router.url);
        this._router.navigate(['/entities/articles/add'], {
          queryParams: { returnURL: currentUrl },
        });
        break;
      case 'update':
        currentUrl = encodeURIComponent(this._router.url);
        this._router.navigate(['/entities/articles/update', obj._id], {
          queryParams: { returnURL: currentUrl },
        });
        break;
      case 'delete':
        currentUrl = encodeURIComponent(this._router.url);
        this._router.navigate(['/entities/articles/delete', obj._id], {
          queryParams: { returnURL: currentUrl },
        });
        break;
      case 'uploadFile':
